...
export function DashboardEmptyState({
  ...
  return (
    <div className='flex min-h-[480px] items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white p-6'>
      <div className='flex w-full max-w-[550px] flex-col items-center gap-5 text-center'>
        <Icon className='size-16 shrink-0 text-carbon-black' strokeWidth={1.5} />
