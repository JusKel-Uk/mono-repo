...
export function ScoreGauge() {
  return (
    <div className='relative h-30 w-full' data-name='Meter Base'>
      {/* arc track */}
      <div className='absolute left-1/2 top-1/2 h-25 w-50 -translate-x-1/2 -translate-y-1/2'>
      ...
      {/* value pin */}
      <div className='absolute bottom-1 left-[calc(50%+0.72px)] h-[34.05px] w-[33.435px] -translate-x-1/2'>
        <img
          alt=''
          src={`${L}/pin.svg`}
